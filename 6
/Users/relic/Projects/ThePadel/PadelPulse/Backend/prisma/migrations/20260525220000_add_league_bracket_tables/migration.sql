...
-- AddForeignKey
ALTER TABLE "LeagueBracketSlot" ADD CONSTRAINT "LeagueParticipantId_fkey" FOREIGN KEY ("leagueParticipantId") REFERENCES "LeagueParticipant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
