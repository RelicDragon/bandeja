#!/usr/bin/env python3
"""Fetch Lithuania clubs from padellands.com → scripts/data/lithuania-padellands-clubs.json"""
...
OUT_PATH = OUT_DIR / "lithuania-padellands-clubs.json"
INDEX_PATH = OUT_DIR / "lithuania-padellands-index.json"
UA = "BandejaLithuaniaImport/1.0"
EUROPA_ID = 6393
REGION_SLUG = "lituania"
REGION_NAME = "Lithuania"
COUNTRY_ALIASES = r"Lithuania|Lituania|Lietuva|Litauen"
...
def main():
    ...
    # Prefer fresh index; fall back to cached if API still 503
    try:
        posts = fetch_index()
        ...
        # re-parse cityFromDesc with improved cleaner
        for c in index:
