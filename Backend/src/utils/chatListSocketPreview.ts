...
export function lastMessageForUnreadListSocket(message: unknown): Record<string, unknown> | undefined {
  ...
  const previewInput = {
    ...
    stickerEmoji: (m.stickerEmoji as string | null) ?? null,
    documentFileName: (m.documentFileName as string | null) ?? null,
  ...
  return {
    ...
    videoDurationMs: m.videoDurationMs ?? null,
    documentFileName: m.documentFileName ?? null,
