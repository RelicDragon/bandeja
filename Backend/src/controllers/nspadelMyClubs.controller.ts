...
import * as nspadelMyClubsService from '../services/nspadel/nspadelMyClubs.service';
import * as booktimeGameLinkService from '../services/booktime/booktimeGameLink.service';

export const getMyNspadelClubs = asyncHandler(async (req: AuthRequest, res: Response) => {
  const payload = await nspadelMyClubsService.getMyNspadelClubs(req.userId!);
