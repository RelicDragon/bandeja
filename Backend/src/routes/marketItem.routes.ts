...
router.get('/:id/bids', optionalAuth, marketItemController.getBids);
router.post('/:id/bids', authenticate, marketItemController.placeBid);
router.post('/:id/accept-buy-it-now', authenticate, marketItemController.acceptBuyItNow);
