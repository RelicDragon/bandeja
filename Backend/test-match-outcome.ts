...
} from './src/services/results/calculator.service';
import { WinnerOfMatch, WinnerOfGame } from '@prisma/client';
...
function calculateMatchWinner(sets: SetScore[], winnerOfMatch: WinnerOfMatch): 'teamA' | 'teamB' | 'tie' {
...
async function main() {
  ...
  let winnerOfGame: WinnerOfGame = WinnerOfGame.BY_MATCHES_WON;
