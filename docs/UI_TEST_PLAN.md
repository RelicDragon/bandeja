...
| CH-52a | Failed create shows in-dialog error | Submit bug with API failure (4xx/5xx or network) | Modal stays open; `bug-create-error` alert is visible (not toast-only); submit re-enables |
