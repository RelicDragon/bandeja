...
| F-59 | Find excludes ARCHIVED from calendar page | Busy city with hundreds of ARCHIVED in the visible month grid | Month cards / dayIndex are live statuses only; late-month days still badge and list (archived history must not consume the ASC take) |
