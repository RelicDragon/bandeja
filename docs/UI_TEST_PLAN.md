...
| F-79 | Find day cards leave skeleton on fast 5G | Cap iOS/Android on a fast network; open Find so weather + calendar occupancy paint while day cards are still skeletons | Cards (or empty/retry) replace skeletons as soon as the day fetch settles — list must not stay on skeletons while occupancy is already showing |
