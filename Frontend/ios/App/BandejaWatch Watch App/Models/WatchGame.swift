...
struct WatchGame: Decodable, Identifiable, Sendable {
    ...
    let deucesBeforeGoldenPoint: Int?
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        deucesBeforeGoldenPoint = try c.decodeIfPresent(Int.self, forKey: .deucesBeforeGoldenPoint)
        ...
        playersPerMatch = try c.decodeIfPresent(Int.self, forKey: .playersPerMatch)
