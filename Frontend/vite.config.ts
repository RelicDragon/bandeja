...
export default defineConfig(({ command, mode }) => {
  ...
  define: {
    ...
    'import.meta.env.VITE_GAME_SERIES_ENABLED': JSON.stringify(process.env.VITE_GAME_SERIES_ENABLED ?? ''),
    'import.meta.env.VITE_COST_SPLIT_ENABLED': JSON.stringify(process.env.VITE_COST_SPLIT_ENABLED ?? ''),
    'import.meta.env.VITE_SHOP_ENABLED': JSON.stringify(process.env.VITE_SHOP_ENABLED ?? ''),
