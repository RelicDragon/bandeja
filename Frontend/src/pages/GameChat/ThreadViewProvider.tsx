...
export function ThreadViewProvider({ children, ...props }: GameChatProps & { children: ReactNode }) {
  ...
  const chrome = useMemo(
    (): import('./ThreadViewContext').ThreadChromeValue => ({
      ...
      isGameChatArchived: ctrl.isGameChatArchived,
      isGameChatAccessDenied: ctrl.isGameChatAccessDenied,
      archivedGameMeta: ctrl.archivedGameMeta,
      game: ctrl.game,
      bug: ctrl.bug,
      userChat: ctrl.userChat,
      groupChannel: ctrl.groupChannel,
      ...
      forwardingMessage: ctrl.forwardingMessage,
      setForwardingMessage: ctrl.setForwardingMessage,
      forwardContextType: ctrl.forwardContextType,
      forwardContextId: ctrl.forwardContextId,
    ...
    [
      ...
      ctrl.currentChatType,
      ctrl.isEmbedded,
      ctrl.isGameChatArchived,
      ctrl.isGameChatAccessDenied,
      ctrl.archivedGameMeta,
      ctrl.game,
      ctrl.bug,
      ctrl.userChat,
      ctrl.groupChannel,
      ...
      ctrl.forwardingMessage,
      ctrl.setForwardingMessage,
      ctrl.forwardContextType,
      ctrl.forwardContextId,
