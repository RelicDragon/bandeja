            ...
            <div>
              ...
              <Select
                options={[
                  ...
                  { value: 'zh-CN', label: '中文', icon: <span className="text-sm leading-none">{getLanguageFlag('zh')}</span> },
                  { value: 'id-ID', label: 'Bahasa Indonesia', icon: <span className="text-sm leading-none">{getLanguageFlag('id')}</span> },
                  { value: 'hi-IN', label: 'हिन्दी', icon: <span className="text-sm leading-none">{getLanguageFlag('hi')}</span> },
                  { value: 'th-TH', label: 'ไทย', icon: <span className="text-sm leading-none">{getLanguageFlag('th')}</span> },
                  { value: 'ja-JP', label: '日本語', icon: <span className="text-sm leading-none">{getLanguageFlag('ja')}</span> },
