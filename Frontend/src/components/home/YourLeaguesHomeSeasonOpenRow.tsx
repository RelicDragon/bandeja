...
export function YourLeaguesHomeSeasonOpenRow({
  ...
  return (
    <button
      ...
      className="flex min-h-[3.25rem] w-full items-center gap-2.5 border-b border-gray-200/80 px-3 py-2.5 text-start transition-colors hover:bg-gray-50 active:bg-gray-100 dark:border-gray-700/80 dark:hover:bg-gray-800/60 dark:active:bg-gray-800"
    >
        {stale ? (
