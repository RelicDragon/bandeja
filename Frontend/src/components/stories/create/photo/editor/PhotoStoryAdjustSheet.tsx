...
type PhotoStoryAdjustSheetProps = {
  ...
  onPreview: (adjust: StoryMediaAdjust) => void;
  ...
  return (
    ...
    >
      <SliderRow
        ...
        disabled={disabled}
        onChange={(brightness) => preview({ ...local, brightness })}
      ...
      <SliderRow
        ...
        disabled={disabled}
        onChange={(contrast) => preview({ ...local, contrast })}
        onRelease={commitLocal}
      />
      <SliderRow
        ...
        disabled={disabled}
        onChange={(saturation) => preview({ ...local, saturation })}
        onRelease={commitLocal}
      />
