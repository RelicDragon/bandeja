...
export const TRANSFORMER_ANCHOR_SCREEN_PX = 11;
export const TRANSFORMER_ROTATE_OFFSET_SCREEN_PX = 32;
export const TRANSFORMER_HIT_SCREEN_PX = 44;
export const TRANSFORMER_BORDER_SCREEN_PX = 1.5;
export const TRANSFORMER_CORNER_RADIUS_SCREEN_PX = 6;
export const TRANSFORMER_ANCHOR_STROKE_SCREEN_PX = 1.25;

export const TRANSFORMER_BORDER_COLOR = 'rgba(255, 255, 255, 0.95)';
export const TRANSFORMER_ANCHOR_FILL = '#ffffff';
export const TRANSFORMER_ANCHOR_STROKE = 'rgba(0, 0, 0, 0.12)';
