        ...
        return (
          ...
          >
            <button
              ...
              className="flex h-full w-full items-center justify-center bg-transparent p-1 transition-transform active:scale-95 disabled:opacity-50 hover:bg-black/[0.04] dark:hover:bg-white/[0.06] rounded-lg"
            ...
            {onToggleFavorite ? (
              <button
                ...
                className={`absolute right-0.5 top-0.5 flex h-6 w-6 items-center justify-center rounded-full text-[11px] leading-none shadow-sm ${
                  isFav
