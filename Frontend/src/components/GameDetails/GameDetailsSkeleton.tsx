...
const ParticipantsSkeletonCard = () => (
  <Card className="p-4">
    <div className="space-y-4">
...
export const GameDetailsSkeleton = () => (
  <AnimatedChildrenStagger contentKey="game-details-skeleton" className="max-w-2xl mx-auto space-y-4 p-0" aria-busy="true">
    <div key="skeleton-info" className="contents">
      <InfoSkeletonCard />
    </div>
    <div key="skeleton-participants" className="contents">
      <ParticipantsSkeletonCard />
    </div>
    <div key="skeleton-action" className="contents">
      <ActionSkeletonCard />
    </div>
    <div key="skeleton-footer" className="contents">
      <FooterSkeletonCard />
    </div>
