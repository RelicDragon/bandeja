        ...
        <div className="flex-1 relative">
          ...
          {showLeftFade && (
            <>
              ...
              <ChevronLeft size={16} className="absolute left-0 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 pointer-events-none z-20" />
            </>
          )}
          {showRightFade && (
            <>
              ...
              <ChevronRight size={16} className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 pointer-events-none z-20" />
            </>
          )}
        </div>
      </div>
  ...
  return (
    <div className="relative">
      ...
      {showLeftFade && (
        <>
          <div className="absolute top-0 bottom-0 -left-1 w-8 bg-gradient-to-r from-white from-0% via-white/90 via-30% to-transparent to-100% dark:from-gray-900 dark:via-gray-900/90 pointer-events-none z-10" />
          <ChevronLeft size={16} className="absolute left-0 top-8 -translate-y-1/2 text-gray-400 dark:text-gray-500 pointer-events-none z-20" />
        </>
      )}
      {showRightFade && (
        <>
          <div className="absolute top-0 bottom-0 -right-1 w-8 bg-gradient-to-l from-white from-0% via-white/90 via-30% to-transparent to-100% dark:from-gray-900 dark:via-gray-900/90 pointer-events-none z-10" />
          <ChevronRight size={16} className="absolute right-0 top-8 -translate-y-1/2 text-gray-400 dark:text-gray-500 pointer-events-none z-20" />
        </>
      )}
    </div>
  );
