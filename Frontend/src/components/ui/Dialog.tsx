...
const DIALOG_CONTENT_CLASS =
  'cap-keyboard-aware-dialog dialog-content-animate fixed left-[50%] top-[50%] z-50 w-[90vw] max-w-[420px] max-h-[85vh] min-h-0 translate-x-[-50%] translate-y-[-50%] flex flex-col overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-white text-gray-900 dark:bg-gray-900 dark:text-white shadow-2xl focus:outline-none';
