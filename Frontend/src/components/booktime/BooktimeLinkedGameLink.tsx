...
export function BooktimeLinkedGameLink({ game }: Props) {
  ...
  return (
    <button
      ...
      className="mt-1.5 flex w-full min-w-0 items-center gap-1.5 rounded-md border border-primary-200/60 bg-primary-50/80 px-2 py-1.5 text-start transition-colors hover:bg-primary-100/80 dark:border-primary-800/50 dark:bg-primary-950/30 dark:hover:bg-primary-950/50"
    >
