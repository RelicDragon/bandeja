  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        viber: '#7360f2',
        primary: {
          DEFAULT: 'var(--member-primary-default, #0ea5e9)',
          foreground: '#ffffff',
          50: 'var(--member-primary-50, #f0f9ff)',
          100: 'var(--member-primary-100, #e0f2fe)',
          200: 'var(--member-primary-200, #bae6fd)',
          300: 'var(--member-primary-300, #7dd3fc)',
          400: 'var(--member-primary-400, #38bdf8)',
          500: 'var(--member-primary-500, #0ea5e9)',
          600: 'var(--member-primary-600, #0284c7)',
          700: 'var(--member-primary-700, #0369a1)',
          800: 'var(--member-primary-800, #075985)',
          900: 'var(--member-primary-900, #0c4a6e)',
          950: 'var(--member-primary-950, #082f49)',
        },
      },
    },
  },
