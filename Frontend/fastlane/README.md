...
### android review_status

```sh
[bundle exec] fastlane android review_status
```
...
```sh
[bundle exec] fastlane ios remove_from_review
```

Remove an explicitly approved iOS submission from App Review
